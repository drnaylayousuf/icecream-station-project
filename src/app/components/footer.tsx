    ...
    <footer className="bg-gradient-to-r from-teal-400 to-pink-500 py-8"> {/* Teal and Pink gradient */}
      <div className="container mx-auto px-4 text-center text-gray-800">
        ...
        <ul className="mb-4">
          ...
          <li className="inline-block mx-2">
            <a href="/information" className="hover:text-gray-600">Information</a>
          </li>
        </ul>
        <div className="mb-4">
          <h3 className="text-lg font-semibold">Contact Us</h3>
          <p className="text-sm">Email: contact@icecreamshop.com</p>
          <p className="text-sm">Phone: (0300) 1234567</p>
        </div>
        <p className="text-sm">&copy; {new Date().getFullYear()} Ice Cream Shop. All rights reserved.</p>
      </div>
    </footer>
  );
};
