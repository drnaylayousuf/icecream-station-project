...
export default function Locationpage() {
  const locations = [
    ...
    },
    {
      ...
      details: [
        {
          address: "Lush Crush Islamabad - F 10",
          contact: "03011179158",
          description:
            "F10 Markaz Sermad Filling Station Total Parco",
        },
        {
          address: "Lush Crush Central Park",
          contact: "03011179158",
    ...
    },
    {
      ...
      details: [
        ...
        {
          address: "Lush Crush DHA Phase 5",
          contact: "03011179158",
    ...
    },
    {
      ...
      details: [
        {
          address: "Lush Crush Jinnah Park",
          contact: "0301-1179158",
          description: "Rawalpindi Near Parsley Restaurant",
        },
        {
          address: "Lush Crush Bahria PH7",
          contact: "0301-1179158",
